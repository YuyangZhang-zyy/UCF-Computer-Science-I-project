...
node_t * addTree(node_t * t1, node_t * t2)
{
    //determine if each roots are NULL
    if(t1 == NULL && t2 == NULL)
        return NULL;
    if(t1 == NULL)
        return t2;
    ...
    t1->data = t1->data + t2->data;//plus
    t1->leftchild = addTree(t1->leftchild, t2->leftchild);//recur to the left child, replace the parameters with the corresponding left and right children
    t1->rightchild = addTree(t1->rightchild, t2->rightchild);//recur to the right child, replace the parameters with the corresponding left and right children
...
node_t * subtractTree(node_t * t1, node_t * t2)
{
    ...
    t1->data = t1->data - t2->data;//subtract
    t1->leftchild = subtractTree(t1->leftchild, t2->leftchild);//recur to the left child, replace the parameters with the corresponding left and right children
    t1->rightchild = subtractTree(t1->rightchild, t2->rightchild);//recur to the right child, replace the parameters with the corresponding left and right children
